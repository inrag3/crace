...
using PG;
using UnityEngine;
using ICoroutinePerformer = Game.Services.CoroutinePerformer.ICoroutinePerformer;
    ...
    public class Engine : IEngine
    {
        ...
        public void FixedTick()
        {
            ...
            var targetRevolutionsPerMinute = (averageRotationPerMinute * _gearbox.CurrentGear) <= 0
                ...
                : RevolutionsPerMinute * Mathf.Abs( (float)_gearbox.GetRatio(_gearbox.CurrentGear));
